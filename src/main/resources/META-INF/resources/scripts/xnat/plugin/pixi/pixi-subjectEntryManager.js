...
(function (factory) {
    ...
    //
    //                         this.subjectsSelector.populate(project);
    //
    //                         document.addEventListener('project-changed', () => this.subjectsSelector.populate(project));
    //                     });
    //     }
    //
    //     getXsiType() { return '' }
    ...
    //         await super.subjectsSelected(subjects);
    //
    //         let hotData = JSON.parse(JSON.stringify(this.hot.getSourceData()));
    //
    //         // Remove deselected subjects
    //         hotData = hotData.filter(row => subjects.contains(row['subjectId']))
    //
    ...
    class SubjectEntryManager extends XNAT.plugin.pixi.abstractDataManager {
        ...
        createActionLabel() { return 'New subjects' }
